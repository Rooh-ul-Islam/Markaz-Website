...
export default function DonationBanner() {
  return (
    <section className="bg-cyan-50 text-cyan-700 py-16 px-6 sm:px-12 lg:px-16">
      <motion.div
      ...
      >
        <div className="text-5xl font-bold mb-6 relative inline-block">
          ...
          <span className="absolute bottom-0 left-0 w-full h-1 mt-2 bg-gradient-to-r from-cyan-700 to-blue-800 rounded-full" />
        </div>

        <p className="text-lg md:text-xl text-cyan-700 mb-6">
